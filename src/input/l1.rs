...
mod test {
    ...
    use hotshot_contract_adapter::sol_types::StakeTableV3::{
        ...
        ValidatorExit, ValidatorRegisteredV2, Withdrawal, X25519KeyUpdated,
    };
    ...
    async fn test_simultaneous_pending_undelegation_and_exit() {
        ...
        let block4 = block3
            .next(
                &NoMetadata,
                &BlockInput::empty(4).with_event(StakeTableV3Events::Withdrawal(Withdrawal {
                    account: delegator,
                    amount: U256::from(400),
                })),
            )
        ...
        let block5 = block4
            .next(
                &NoMetadata,
                &BlockInput::empty(5).with_event(StakeTableV3Events::Withdrawal(Withdrawal {
                    account: delegator,
