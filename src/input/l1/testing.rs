...
use hotshot_contract_adapter::{
    sol_types::{
        ...
        StakeTableV3::{
            ...
            MetadataUriUpdated, Undelegated, ValidatorExit, ValidatorRegistered,
            ValidatorRegisteredV2, ValidatorRegisteredV3, Withdrawal,
        },
    },
        ...
        loop {
            ...
            let event = match event_type {
                ...
                WITHDRAWAL => {
                    ...
                    StakeTableV3Events::Withdrawal(Withdrawal { account, amount }).into()
                }
